    ...
    return(
        <div className="relative pt-5 pb-20 px-4 md:px-8 md:pt-8 md:pb-[60px] xl:pt-10 xl:px-36 xl:pb-[231px]">
            ...
            <div className="text-center md:text-left md:max-w-[443px] md:relative md:z-10 md:mt-[90px] xl:mt-[127px] xl:max-w-[709px]">
                ...
                <p className="text-mobm text-grey my-6 md:text-m xl:mt-[43px] xl:mb-[66px] xl:max-w-[445px]">Based in the UK, I'm a front-end developer passionate about building accessible web apps that users love.</p>
                <span className=" text-mobm font-bold leading-[26px] tracking-[2.286px] text-white underline decoration-green decoration-2 underline-offset-[10px] cursor-pointer hover:text-green">CONTACT ME</span>
            </div>
